...
extern "C" {
    ...
    LLAMA_API size_t llama_memory_kv_cache_size(llama_memory_t mem, uint64_t node_size);
    LLAMA_API bool llama_memory_is_reusable(llama_memory_t mem, const llama_seq_id seq_id, const size_t count, bool* reusable);
    LLAMA_API void llama_memory_kv_read(llama_memory_t mem, void *ptr, const size_t node_stride, const uint32_t node_size, const llama_seq_id seq_id, const llama_pos start_pos, const size_t count, bool is_last_node, const llama_pos * mrope_pos);
    LLAMA_API void llama_memory_kv_write(llama_memory_t mem, void *ptr, const size_t node_stride, const uint32_t node_size, const llama_seq_id seq_id, const llama_pos start_pos, const size_t count, bool is_last_node, const llama_pos * mrope_pos);

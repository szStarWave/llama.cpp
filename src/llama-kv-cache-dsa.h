...
public:
    ...
    void kv_cache_read(void* k_ptr, const size_t &node_stride, const uint32_t &node_size, const llama_seq_id &seq_id, const llama_pos &start_pos, const size_t &count, const bool is_last_node, uint32_t mask, const llama_pos * mrope_pos = nullptr) override;

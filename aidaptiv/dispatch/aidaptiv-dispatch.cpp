...
size_t stub_kv_cache_get_cache_size(const llama_kv_cache &, uint64_t) {
    aidaptiv_not_loaded("kv_cache_get_cache_size");
}
void stub_kv_cache_read(llama_kv_cache &, void *, const size_t &, const uint32_t &, const llama_seq_id &, const llama_pos &, const size_t &, bool, const llama_pos *) {
    aidaptiv_not_loaded("kv_cache_read");
}
void stub_kv_cache_write(llama_kv_cache &, void *, const size_t &, const uint32_t &, const llama_seq_id &, const llama_pos &, const size_t &, bool, const llama_pos *) {
    aidaptiv_not_loaded("kv_cache_write");
}
bool stub_is_reusable(llama_kv_cache &, const llama_seq_id &, const size_t &, bool *) {
    aidaptiv_not_loaded("is_reusable");
}

uint32_t stub_mr_get_size(const llama_memory_recurrent &) {
    aidaptiv_not_loaded("mr_get_size");
}
size_t stub_mr_get_cache_size(const llama_memory_recurrent &, uint64_t) {
    aidaptiv_not_loaded("mr_get_cache_size");
}
bool stub_mr_is_reusable(llama_memory_recurrent &, const llama_seq_id &, const size_t &, bool *) {
    aidaptiv_not_loaded("mr_is_reusable");
}
void stub_mr_kv_cache_read(const llama_memory_recurrent &, void *, const size_t &, const uint32_t &, const llama_seq_id &, const llama_pos &, const size_t &, bool, const llama_pos *) {
    aidaptiv_not_loaded("mr_kv_cache_read");
}
void stub_mr_kv_cache_write(llama_memory_recurrent &, void *, const size_t &, const uint32_t &, const llama_seq_id &, const llama_pos &, const size_t &, bool, const llama_pos *) {
...
size_t stub_iswa_get_cache_size(const llama_kv_cache_iswa &, uint64_t) {
    aidaptiv_not_loaded("iswa_get_cache_size");
}
bool stub_iswa_is_reusable(llama_kv_cache_iswa &, const llama_seq_id &, const size_t &, bool *) {
    aidaptiv_not_loaded("iswa_is_reusable");
}
void stub_iswa_kv_cache_read(llama_kv_cache_iswa &, void *, const size_t &, const uint32_t &, const llama_seq_id &, const llama_pos &, const size_t &, bool, const llama_pos *) {
    aidaptiv_not_loaded("iswa_kv_cache_read");
}
void stub_iswa_kv_cache_write(llama_kv_cache_iswa &, void *, const size_t &, const uint32_t &, const llama_seq_id &, const llama_pos &, const size_t &, bool, const llama_pos *) {
...
size_t stub_hyb_get_cache_size(const llama_memory_hybrid &, uint64_t) {
    aidaptiv_not_loaded("hyb_get_cache_size");
}
bool stub_hyb_is_reusable(llama_memory_hybrid &, const llama_seq_id &, const size_t &, bool *) {
    aidaptiv_not_loaded("hyb_is_reusable");
}
void stub_hyb_kv_cache_read(llama_memory_hybrid &, void *, const size_t &, const uint32_t &, const llama_seq_id &, const llama_pos &, const size_t &, bool, const llama_pos *) {
    aidaptiv_not_loaded("hyb_kv_cache_read");
}
void stub_hyb_kv_cache_write(llama_memory_hybrid &, void *, const size_t &, const uint32_t &, const llama_seq_id &, const llama_pos &, const size_t &, bool, const llama_pos *) {
...
size_t stub_hyb_iswa_get_cache_size(const llama_memory_hybrid_iswa &, uint64_t) {
    aidaptiv_not_loaded("hyb_iswa_get_cache_size");
}
bool stub_hyb_iswa_is_reusable(llama_memory_hybrid_iswa &, const llama_seq_id &, const size_t &, bool *) {
    aidaptiv_not_loaded("hyb_iswa_is_reusable");
}
void stub_hyb_iswa_kv_cache_read(llama_memory_hybrid_iswa &, void *, const size_t &, const uint32_t &, const llama_seq_id &, const llama_pos &, const size_t &, bool, const llama_pos *) {
    aidaptiv_not_loaded("hyb_iswa_kv_cache_read");
}
void stub_hyb_iswa_kv_cache_write(llama_memory_hybrid_iswa &, void *, const size_t &, const uint32_t &, const llama_seq_id &, const llama_pos &, const size_t &, bool, const llama_pos *) {
...
void stub_model_setup_moe_offload(llama_model_base &, int, aidaptiv_moe_offload_params *) {
    // No aiDAPTIV runtime is registered. Keep normal model loading available and
    // report MoE offload as disabled through the query path below.
}

...
struct aidaptiv_dispatch {
    // ---- llama_kv_cache ----
    size_t (*kv_cache_get_cache_size )(const llama_kv_cache & self, uint64_t node_size);
    void   (*kv_cache_read           )(llama_kv_cache & self, void * ptr, const size_t & node_stride, const uint32_t & node_size, const llama_seq_id & seq_id, const llama_pos & start_pos, const size_t & count, bool is_last_node, const llama_pos * mrope_pos);
    void   (*kv_cache_write          )(llama_kv_cache & self, void * ptr, const size_t & node_stride, const uint32_t & node_size, const llama_seq_id & seq_id, const llama_pos & start_pos, const size_t & count, bool is_last_node, const llama_pos * mrope_pos);
    bool   (*is_reusable             )(llama_kv_cache & self, const llama_seq_id & seq_id, const size_t & count, bool * reusable);

    // ---- llama_memory_recurrent ----
    uint32_t (*mr_get_size          )(const llama_memory_recurrent & self);
    size_t   (*mr_get_cache_size    )(const llama_memory_recurrent & self, uint64_t node_size);
    bool     (*mr_is_reusable       )(llama_memory_recurrent & self, const llama_seq_id & seq_id, const size_t & count, bool * reusable);
    void     (*mr_kv_cache_read     )(const llama_memory_recurrent & self, void * ptr, const size_t & node_stride, const uint32_t & node_size, const llama_seq_id & seq_id, const llama_pos & start_pos, const size_t & count, bool is_last_node, const llama_pos * mrope_pos);
    void     (*mr_kv_cache_write    )(llama_memory_recurrent & self, void * ptr, const size_t & node_stride, const uint32_t & node_size, const llama_seq_id & seq_id, const llama_pos & start_pos, const size_t & count, bool is_last_node, const llama_pos * mrope_pos);

    // ---- llama_kv_cache_iswa ----
    uint32_t (*iswa_get_size          )(const llama_kv_cache_iswa & self);
    size_t   (*iswa_get_cache_size    )(const llama_kv_cache_iswa & self, uint64_t node_size);
    bool     (*iswa_is_reusable       )(llama_kv_cache_iswa & self, const llama_seq_id & seq_id, const size_t & count, bool * reusable);
    void     (*iswa_kv_cache_read     )(llama_kv_cache_iswa & self, void * ptr, const size_t & node_stride, const uint32_t & node_size, const llama_seq_id & seq_id, const llama_pos & start_pos, const size_t & count, bool is_last_node, const llama_pos * mrope_pos);
    void     (*iswa_kv_cache_write    )(llama_kv_cache_iswa & self, void * ptr, const size_t & node_stride, const uint32_t & node_size, const llama_seq_id & seq_id, const llama_pos & start_pos, const size_t & count, bool is_last_node, const llama_pos * mrope_pos);

    // ---- llama_memory_hybrid ----
    uint32_t (*hyb_get_size          )(const llama_memory_hybrid & self);
    size_t   (*hyb_get_cache_size    )(const llama_memory_hybrid & self, uint64_t node_size);
    bool     (*hyb_is_reusable       )(llama_memory_hybrid & self, const llama_seq_id & seq_id, const size_t & count, bool * reusable);
    void     (*hyb_kv_cache_read     )(llama_memory_hybrid & self, void * ptr, const size_t & node_stride, const uint32_t & node_size, const llama_seq_id & seq_id, const llama_pos & start_pos, const size_t & count, bool is_last_node, const llama_pos * mrope_pos);
    void     (*hyb_kv_cache_write    )(llama_memory_hybrid & self, void * ptr, const size_t & node_stride, const uint32_t & node_size, const llama_seq_id & seq_id, const llama_pos & start_pos, const size_t & count, bool is_last_node, const llama_pos * mrope_pos);

    // ---- llama_memory_hybrid_iswa ----
    uint32_t (*hyb_iswa_get_size          )(const llama_memory_hybrid_iswa & self);
    size_t   (*hyb_iswa_get_cache_size    )(const llama_memory_hybrid_iswa & self, uint64_t node_size);
    bool     (*hyb_iswa_is_reusable       )(llama_memory_hybrid_iswa & self, const llama_seq_id & seq_id, const size_t & count, bool * reusable);
    void     (*hyb_iswa_kv_cache_read     )(llama_memory_hybrid_iswa & self, void * ptr, const size_t & node_stride, const uint32_t & node_size, const llama_seq_id & seq_id, const llama_pos & start_pos, const size_t & count, bool is_last_node, const llama_pos * mrope_pos);
    void     (*hyb_iswa_kv_cache_write    )(llama_memory_hybrid_iswa & self, void * ptr, const size_t & node_stride, const uint32_t & node_size, const llama_seq_id & seq_id, const llama_pos & start_pos, const size_t & count, bool is_last_node, const llama_pos * mrope_pos);
